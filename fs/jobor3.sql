...
-- ----------------------------
BEGIN;
INSERT IGNORE INTO `jobor_task` (`id`, `name`, `description`, `lang`, `data`, `notify`, `user_id`, `user`, `count`, `parent_task_ids`, `parent_run_parallel`, `child_task_ids`, `child_run_parallel`, `expr`, `timeout`, `route_policy`, `routing_key`, `routing_keys`, `status`, `alarm_policy`, `expect_content`, `expect_code`, `retry`, `prev`, `next`, `updater`, `deleted`) VALUES (1, 'ShellDemo', 'ShellDemo', 'shell', '{\"content\":\"#!/bin/bash \\necho `date`\\nsleep 10\\necho \\\"wellcome use jobor cron task!\\\"\",\"api\":{\"url\":\"\",\"method\":\"get\",\"content_type\":\"json\",\"payload\":\"\",\"body\":\"\",\"auth_method\":\"no_auth\",\"auth_data\":{\"username\":\"\",\"password\":\"\"},\"header_list\":[],\"form_data_list\":[],\"www_form_list\":[],\"header\":null,\"forms\":null}}', '{\"email\":{},\"webhook\":{},\"lark\":{},\"dingding\":{},\"wechat\":{}}', 0, '', 0, NULL, 0, NULL, 0, '0 */2 * * * *', 120, 1, 'default', '[\"default\"]', 'stop', 2, 'wellcome use jobor', 1, 0, '2023-09-13 13:30:28', '0001-01-01 00:00:00', '', 0);
INSERT IGNORE INTO `jobor_task` (`id`, `name`, `description`, `lang`, `data`, `notify`, `user_id`, `user`, `count`, `parent_task_ids`, `parent_run_parallel`, `child_task_ids`, `child_run_parallel`, `expr`, `timeout`, `route_policy`, `routing_key`, `routing_keys`, `status`, `alarm_policy`, `expect_content`, `expect_code`, `retry`, `prev`, `next`, `updater`, `deleted`) VALUES (2, 'ApiDemo', 'ApiDemo', 'api', '{\"content\":\"#!/bin/bash \\necho `date`\\nsleep 60\\necho \\\"wellcome use jobor cron task!\\\"\",\"api\":{\"url\":\"http://127.0.0.1:5002/ping\",\"method\":\"GET\",\"content_type\":\"json\",\"payload\":\"\",\"body\":\"\",\"auth_method\":\"no_auth\",\"auth_data\":{\"username\":\"\",\"password\":\"\"},\"header_list\":[{\"key\":\"abc\",\"value\":\"abc\"}],\"form_data_list\":[],\"www_form_list\":[],\"header\":null,\"forms\":null}}', '{\"email\":{},\"webhook\":{},\"lark\":{},\"dingding\":{},\"wechat\":{}}', 0, '', 0, NULL, 0, NULL, 0, '0 */2 * * * *', 120, 1, 'default', '[\"default\"]', 'stop', 2, '', 200, 0, '2023-09-13 13:30:30', '0001-01-01 00:00:00', '', 0);
INSERT IGNORE INTO `jobor_task` (`id`, `name`, `description`, `lang`, `data`, `notify`, `user_id`, `user`, `count`, `parent_task_ids`, `parent_run_parallel`, `child_task_ids`, `child_run_parallel`, `expr`, `timeout`, `route_policy`, `routing_key`, `routing_keys`, `status`, `alarm_policy`, `expect_content`, `expect_code`, `retry`, `prev`, `next`, `updater`, `deleted`) VALUES (3, 'sshModeDemo', '', 'shell', '{\"content\":\"#!/bin/bash\\nexport PATH=/usr/local/bin:/usr/bin:/usr/local/sbin:/usr/sbin:/data/consul/bin:/data/jdk1.8.0_261/bin:/data/jdk1.8.0_261/jre/bin:/data/nginx/sbin:/home/ops/.local/bin:/home/ops/bin\\n\\nifconfig\\n\\n# echo `ip addr`\\n\\necho \\\"wellcome use jobor worker ssh mode!\\\"\\n\",\"api\":{\"url\":\"\",\"method\":\"GET\",\"content_type\":\"json\",\"payload\":\"\",\"body\":\"\",\"auth_method\":\"no_auth\",\"auth_data\":{\"username\":\"\",\"password\":\"\"},\"header_list\":[],\"form_data_list\":[],\"www_form_list\":[],\"header\":null,\"forms\":null}}', '{\"email\":{\"receivers\":[\"\"]},\"webhook\":{},\"lark\":{},\"dingding\":{},\"wechat\":{}}', 0, '', 0, '[]', 0, '[]', 0, '0 0 10 * * *', 60, 1, 'ssh', '[\"ssh\"]', 'stop', 2, '', 0, 0, '2023-09-19 13:04:07', '0001-01-01 00:00:00', '', 0);
INSERT IGNORE INTO `jobor_task` (`id`, `name`, `description`, `lang`, `data`, `notify`, `user_id`, `user`, `count`, `parent_task_ids`, `parent_run_parallel`, `child_task_ids`, `child_run_parallel`, `expr`, `timeout`, `route_policy`, `routing_key`, `routing_keys`, `status`, `alarm_policy`, `expect_content`, `expect_code`, `retry`, `prev`, `next`, `updater`, `deleted`) VALUES (4, 'pyDemo', '', 'python3', '{\"pre_cmd\":\"pip3 install requests\",\"content\":\"def a():\\n  print(\\\"python3:\\\")\\n  \\na()\",\"api\":{\"url\":\"\",\"method\":\"GET\",\"content_type\":\"json\",\"payload\":\"\",\"body\":\"\",\"auth_method\":\"no_auth\",\"auth_data\":{\"username\":\"\",\"password\":\"\"},\"header_list\":[],\"form_data_list\":[],\"www_form_list\":[],\"header\":null,\"forms\":null}}', '{\"email\":{},\"webhook\":{},\"lark\":{},\"dingding\":{},\"wechat\":{}}', 0, '', 0, '[]', 0, '[]', 0, '0 0 10 * * *', 60, 1, 'ssh', '[\"python3.7\"]', 'stop', 2, '', 0, 0, '2023-09-20 20:09:10', '0001-01-01 00:00:00', '', 0);
INSERT IGNORE INTO `jobor_task` (`id`, `name`, `description`, `lang`, `data`, `notify`, `user_id`, `user`, `count`, `parent_task_ids`, `parent_run_parallel`, `child_task_ids`, `child_run_parallel`, `expr`, `timeout`, `route_policy`, `routing_key`, `routing_keys`, `status`, `alarm_policy`, `expect_content`, `expect_code`, `retry`, `prev`, `next`, `updater`, `deleted`) VALUES (5, 'goDemo', '', 'golang', '{\"content\":\"package main\\n\\nimport (\\n\\t\\\"fmt\\\"\\n)\\n\\nfunc main(){\\n  fmt.Println(\\\"hellow go task\\\")\\n}\",\"api\":{\"url\":\"\",\"method\":\"GET\",\"content_type\":\"json\",\"payload\":\"\",\"body\":\"\",\"auth_method\":\"no_auth\",\"auth_data\":{\"username\":\"\",\"password\":\"\"},\"header_list\":[],\"form_data_list\":[],\"www_form_list\":[],\"header\":null,\"forms\":null}}', '{\"email\":{},\"webhook\":{},\"lark\":{},\"dingding\":{},\"wechat\":{}}', 0, '', 0, '[]', 0, '[]', 0, '0 0 10 * * *', 60, 1, 'ssh', '[\"go1.20\"]', 'stop', 2, '', 0, 0, '2023-09-20 20:09:11', '0001-01-01 00:00:00', '', 0);
COMMIT;
