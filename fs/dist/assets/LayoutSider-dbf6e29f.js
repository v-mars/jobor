import{c as J,a as Q,a8 as Z,ab as N,k as Y,e as a,f as p,d as L,u as j,m as R,g as M,p as A,bc as W,i as x,j as V,h as c,ae as H,v as s,t as z,N as ee,A as oe,z as F,bd as _,l as te,B as $}from "./index-18c4e01a.js";import{C as re}from "./Dropdown-a04ac224.js";const le= e=>{const{baseColor:o,textColor2:r,bodyColor:d,cardColor:f,dividerColor:b,actionColor:C,scrollbarColor:S,scrollbarColorHover:v,invertedColor:g}=e;return{textColor:r,textColorInverted:"#FFF",color:d,colorEmbedded:C,headerColor:f,headerColorInverted:g,footerColor:C,footerColorInverted:g,headerBorderColor:b,headerBorderColorInverted:g,footerBorderColor:b,footerBorderColorInverted:g,siderBorderColor:b,siderBorderColorInverted:g,siderColor:f,siderColorInverted:g,siderToggleButtonBorder:`1px solid ${b}`,siderToggleButtonColor:o,siderToggleButtonIconColor:r,siderToggleButtonIconColorInverted:r,siderToggleBarColor:N(d,S),siderToggleBarColorHover:N(d,v),__invertScrollbar:"true"}},ne=J({name:"Layout",common:Q,peers:{Scrollbar:Z},self:le}),U=ne,se=Y("n-layout-sider"),D={type:String,default:"static"},ae=a("layout",`
