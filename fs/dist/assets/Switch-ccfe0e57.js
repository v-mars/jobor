...
`,[t("children-placeholder",`
 ...
 cursor: not-allowed;
 opacity: .5;
 `)])]),Se=Object.assign(Object.assign({},E.props),{size:{type:String,default:"medium"},value:{type:[String,Number,Boolean],default:void 0},loading:Boolean,defaultValue:{type:[String,Number,Boolean],default:!1},disabled:{type:Boolean,default:void 0},round:{type:Boolean,default:!0},"onUpdate:value":[Function,Array],onUpdateValue:[Function,Array],checkedValue:{type:[String,Number,Boolean],default:!0},uncheckedValue:{type:[String,Number,Boolean],default:!1},railStyle:Function,rubberBand:{type:Boolean,default:!0},onChange:[Function,Array]});let B;const Be=ce({name:"Switch",props:Se,setup(e){B===void 0&&(typeof CSS<"u"?typeof CSS.supports<"u"?B=CSS.supports("width","max(1px)"):B=!1:B=!0);const{mergedClsPrefixRef:d,inlineThemeDisabled:f}=ue(e),o=E("Switch","-switch",ke,ye,e,d),r=he(e),{mergedSizeRef:p,mergedDisabledRef:g}=r,k=T(e.defaultValue),R=be(e,"value"),v=fe(R,k),S=z(()=>v.value===e.checkedValue),x=T(!1),a=T(!1),c=z(()=>{const{railStyle:i}=e;if(i)return i({focused:a.value,checked:S.value})});function u(i){const{"onUpdate:value":$,onChange:V,onUpdateValue:_}=e,{nTriggerFormInput:F,nTriggerFormChange:W}=r;$&&j($,i),_&&j(_,i),V&&j(V,i),k.value=i,F(),W()}function I(){const{nTriggerFormFocus:i}=r;i()}function Y(){const{nTriggerFormBlur:i}=r;i()}function X(){e.loading||g.value||(v.value!==e.checkedValue?u(e.checkedValue):u(e.uncheckedValue))}function G(){a.value=!0,I()}function J(){a.value=!1,Y(),x.value=!1}function q(i){e.loading||g.value||i.key===" "&&(v.value!==e.checkedValue?u(e.checkedValue):u(e.uncheckedValue),x.value=!1)}function Q(i){e.loading||g.value||i.key===" "&&(i.preventDefault(),x.value=!0)}const K=z(()=>{const{value:i}=p,{self:{opacityDisabled:$,railColor:V,railColorActive:_,buttonBoxShadow:F,buttonColor:W,boxShadowFocus:Z,loadingColor:ee,textColor:te,iconColor:ie,[w("buttonHeight",i)]:h,[w("buttonWidth",i)]:ae,[w("buttonWidthPressed",i)]:ne,[w("railHeight",i)]:b,[w("railWidth",i)]:C,[w("railBorderRadius",i)]:oe,[w("buttonBorderRadius",i)]:re},common:{cubicBezierEaseInOut:le}}=o.value;let M,H,L;return B?(M=`calc((${b} - ${h}) / 2)`,H=`max(${b}, ${h})`,L=`max(${C}, calc(${C} + ${h} - ${b}))`):(M=N((s(b)-s(h))/2),H=N(Math.max(s(b),s(h))),L=s(b)>s(h)?C:N(s(C)+s(h)-s(b))),{"--n-bezier":le,"--n-button-border-radius":re,"--n-button-box-shadow":F,"--n-button-color":W,"--n-button-width":ae,"--n-button-width-pressed":ne,"--n-button-height":h,"--n-height":H,"--n-offset":M,"--n-opacity-disabled":$,"--n-rail-border-radius":oe,"--n-rail-color":V,"--n-rail-color-active":_,"--n-rail-height":b,"--n-rail-width":C,"--n-width":L,"--n-box-shadow-focus":Z,"--n-loading-color":ee,"--n-text-color":te,"--n-icon-color":ie}}),y=f?ge("switch",z(()=>p.value[0]),K,e):void 0;return{handleClick:X,handleBlur:J,handleFocus:G,handleKeyup:q,handleKeydown:Q,mergedRailStyle:c,pressed:x,mergedClsPrefix:d,mergedValue:v,checked:S,mergedDisabled:g,cssVars:f?void 0:K,themeClass:y==null?void 0:y.themeClass,onRender:y==null?void 0:y.onRender}},render(){const{mergedClsPrefix:e,mergedDisabled:d,checked:f,mergedRailStyle:o,onRender:r,$slots:p}=this;r==null||r();const{checked:g,unchecked:k,icon:R,"checked-icon":v,"unchecked-icon":S}=p,x=!(D(R)&&D(v)&&D(S));return n("div",{role:"switch","aria-checked":f,class:[`${e}-switch`,this.themeClass,x&&`${e}-switch--icon`,f&&`${e}-switch--active`,d&&`${e}-switch--disabled`,this.round&&`${e}-switch--round`,this.loading&&`${e}-switch--loading`,this.pressed&&`${e}-switch--pressed`,this.rubberBand&&`${e}-switch--rubber-band`],tabindex:this.mergedDisabled?void 0:0,style:this.cssVars,onClick:this.handleClick,onFocus:this.handleFocus,onBlur:this.handleBlur,onKeyup:this.handleKeyup,onKeydown:this.handleKeydown},n("div",{class:`${e}-switch__rail`,"aria-hidden":"true",style:o},m(g,a=>m(k,c=>a||c?n("div",{"aria-hidden":!0,class:`${e}-switch__children-placeholder`},n("div",{class:`${e}-switch__rail-placeholder`},n("div",{class:`${e}-switch__button-placeholder`}),a),n("div",{class:`${e}-switch__rail-placeholder`},n("div",{class:`${e}-switch__button-placeholder`}),c)):null)),n("div",{class:`${e}-switch__button`},m(R,a=>m(v,c=>m(S,u=>n(ve,null,{default:()=>this.loading?n(me,{key:"loading",clsPrefix:e,strokeWidth:20}):this.checked&&(c||a)?n("div",{class:`${e}-switch__button-icon`,key:c?"checked-icon":"icon"},c||a):!this.checked&&(u||a)?n("div",{class:`${e}-switch__button-icon`,key:u?"unchecked-icon":"icon"},u||a):null})))),m(g,a=>a&&n("div",{key:"checked",class:`${e}-switch__checked`},a)),m(k,a=>a&&n("div",{key:"unchecked",class:`${e}-switch__unchecked`},a)))))}});export{Be as N};
