...
`,[U("disabled",[T("transfer-list",[T("transfer-list-header",[y("title",`
 ...
 opacity: 1;
 pointer-events: all;
 `)])])])])])])])]),wt=Object.assign(Object.assign({},ne.props),{value:Array,defaultValue:{type:Array,default:null},options:{type:Array,default:()=>[]},disabled:{type:Boolean,default:void 0},virtualScroll:Boolean,sourceTitle:String,targetTitle:String,filterable:{type:Boolean,default:void 0},sourceFilterable:Boolean,targetFilterable:Boolean,showSelected:{type:Boolean,default:!0},sourceFilterPlaceholder:String,targetFilterPlaceholder:String,filter:{type:Function,default:(e,i)=>e?~(""+i.label).toLowerCase().indexOf((""+e).toLowerCase()):!0},size:String,renderSourceLabel:Function,renderTargetLabel:Function,renderSourceList:Function,renderTargetList:Function,"onUpdate:value":[Function,Array],onUpdateValue:[Function,Array],onChange:[Function,Array]}),Lt=L({name:"Transfer",props:wt,setup(e){const{mergedClsPrefixRef:i}=We(e),o=ne("Transfer","-transfer",_t,kt,e,i),t=Xe(e),{mergedSizeRef:n,mergedDisabledRef:s}=t,c=x(()=>{const{value:C}=n,{self:{[A("itemHeight",C)]:w}}=o.value;return Ze(w)}),{uncontrolledValueRef:r,mergedValueRef:h,targetValueSetRef:u,valueSetForCheckAllRef:d,valueSetForUncheckAllRef:p,valueSetForClearRef:F,filteredTgtOptionsRef:z,filteredSrcOptionsRef:R,targetOptionsRef:b,canNotSelectAnythingRef:f,canBeClearedRef:v,allCheckedRef:B,srcPatternRef:N,tgtPatternRef:a,mergedSrcFilterableRef:m,handleSrcFilterUpdateValue:I,handleTgtFilterUpdateValue:_}=Ft(e);function O(C){const{onUpdateValue:w,"onUpdate:value":P,onChange:H}=e,{nTriggerFormInput:W,nTriggerFormChange:X}=t;w&&Y(w,C),P&&Y(P,C),H&&Y(H,C),r.value=C,W(),X()}function ce(){O([...d.value])}function ue(){O([...p.value])}function fe(){O([...F.value])}function Q(C,w){O(C?(h.value||[]).concat(w):(h.value||[]).filter(P=>P!==w))}function he(C){O(C)}return Ye(M,{targetValueSetRef:u,mergedClsPrefixRef:i,disabledRef:s,mergedThemeRef:o,targetOptionsRef:b,canNotSelectAnythingRef:f,canBeClearedRef:v,allCheckedRef:B,srcOptionsLengthRef:x(()=>e.options.length),handleItemCheck:Q,renderSourceLabelRef:E(e,"renderSourceLabel"),renderTargetLabelRef:E(e,"renderTargetLabel"),showSelectedRef:E(e,"showSelected")}),{mergedClsPrefix:i,mergedDisabled:s,itemSize:c,isMounted:Ge(),mergedTheme:o,filteredSrcOpts:R,filteredTgtOpts:z,srcPattern:N,tgtPattern:a,mergedSize:n,mergedSrcFilterable:m,handleSrcFilterUpdateValue:I,handleTgtFilterUpdateValue:_,handleSourceCheckAll:ce,handleSourceUncheckAll:ue,handleTargetClearAll:fe,handleItemCheck:Q,handleChecked:he,cssVars:x(()=>{const{value:C}=n,{common:{cubicBezierEaseInOut:w},self:{borderRadius:P,borderColor:H,listColor:W,titleTextColor:X,titleTextColorDisabled:me,extraTextColor:ge,itemTextColor:ve,itemColorPending:pe,itemTextColorDisabled:be,titleFontWeight:xe,closeColorHover:Se,closeColorPressed:Ce,closeIconColor:Re,closeIconColorHover:ye,closeIconColorPressed:ze,closeIconSize:Te,closeSize:ke,dividerColor:Fe,extraTextColorDisabled:_e,[A("extraFontSize",C)]:we,[A("fontSize",C)]:Le,[A("titleFontSize",C)]:$e,[A("itemHeight",C)]:Oe,[A("headerHeight",C)]:Pe}}=o.value;return{"--n-bezier":w,"--n-border-color":H,"--n-border-radius":P,"--n-extra-font-size":we,"--n-font-size":Le,"--n-header-font-size":$e,"--n-header-extra-text-color":ge,"--n-header-extra-text-color-disabled":_e,"--n-header-font-weight":xe,"--n-header-text-color":X,"--n-header-text-color-disabled":me,"--n-item-color-pending":pe,"--n-item-height":Oe,"--n-item-text-color":ve,"--n-item-text-color-disabled":be,"--n-list-color":W,"--n-header-height":Pe,"--n-close-size":ke,"--n-close-icon-size":Te,"--n-close-color-hover":Se,"--n-close-color-pressed":Ce,"--n-close-icon-color":Re,"--n-close-icon-color-hover":ye,"--n-close-icon-color-pressed":ze,"--n-divider-color":Fe}})}},render(){const{mergedClsPrefix:e,renderSourceList:i,renderTargetList:o,mergedTheme:t,mergedSrcFilterable:n,targetFilterable:s}=this;return l("div",{class:[`${e}-transfer`,this.mergedDisabled&&`${e}-transfer--disabled`],style:this.cssVars},l("div",{class:`${e}-transfer-list ${e}-transfer-list--source`},l(re,{source:!0,title:this.sourceTitle,onCheckedAll:this.handleSourceCheckAll,onClearAll:this.handleSourceUncheckAll,size:this.mergedSize}),l("div",{class:`${e}-transfer-list-body`},n?l(oe,{onUpdateValue:this.handleSrcFilterUpdateValue,value:this.srcPattern,disabled:this.mergedDisabled,placeholder:this.sourceFilterPlaceholder}):null,l("div",{class:`${e}-transfer-list-flex-container`},i?l(G,{theme:t.peers.Scrollbar,themeOverrides:t.peerOverrides.Scrollbar},{default:()=>i({onCheck:this.handleChecked,checkedOptions:this.filteredTgtOpts,pattern:this.srcPattern})}):l(ae,{source:!0,options:this.filteredSrcOpts,disabled:this.mergedDisabled,virtualScroll:this.virtualScroll,itemSize:this.itemSize}))),l("div",{class:`${e}-transfer-list__border`})),l("div",{class:`${e}-transfer-list ${e}-transfer-list--target`},l(re,{onClearAll:this.handleTargetClearAll,size:this.mergedSize,title:this.targetTitle}),l("div",{class:`${e}-transfer-list-body`},s?l(oe,{onUpdateValue:this.handleTgtFilterUpdateValue,value:this.tgtPattern,disabled:this.mergedDisabled,placeholder:this.sourceFilterPlaceholder}):null,l("div",{class:`${e}-transfer-list-flex-container`},o?l(G,{theme:t.peers.Scrollbar,themeOverrides:t.peerOverrides.Scrollbar},{default:()=>o({onCheck:this.handleChecked,checkedOptions:this.filteredTgtOpts,pattern:this.tgtPattern})}):l(ae,{options:this.filteredTgtOpts,disabled:this.mergedDisabled,virtualScroll:this.virtualScroll,itemSize:this.itemSize}))),l("div",{class:`${e}-transfer-list__border`})))}}),$t=L({__name:"ApiTransfer",setup(e){const{data:i,loading:o}=Z(dt.getAllApi,{auto:!0}),t=x(()=>{var c,r,h;return(c=i.value)!=null&&c.list?(h=(r=i.value)==null?void 0:r.list)==null?void 0:h.map(u=>({...u,label:u.title,value:u.id})):[]}),n=function({option:s}){const{title:c,method:r,path:h,name:u}=s;return l(ht,{},{default:()=>`${r} ${h}`,trigger:()=>`${c} ${u}`})};return(s,c)=>(J(),se(g(Lt),Je({loading:g(o),options:g(t)},s.$attrs,{"virtual-scroll":"","source-filterable":"","target-filterable":"","render-source-label":n,"render-target-label":n}),null,16,["loading","options","render-source-label","render-target-label"]))}}),Ot={flex:"","justify-end":""},ie=L({__name:"RoleModal",props:{record:null},emits:["refresh"],setup(e,{emit:i}){const o=e,{record:t}=Qe(o),n=$(!1),s=$(null),{run:c,loading:r}=Z(q.createRole),{run:h,loading:u}=Z(q.editRole),d=$({name:"",parent_id:0,title:"",description:"",sort:100}),p={name:{required:!0,message:"请输入角色名",trigger:"blur"},code:{required:!0,message:"请输入code",trigger:"blur"}};function F(){n.value=!0,t!=null&&t.value&&(d.value={...t.value,api_ids:t.value.apis.map(b=>b.id)})}const z=x(()=>!!(t!=null&&t.value));function R(){var b;(b=s.value)==null||b.validate(async f=>{if(f)return;const{result:v}=t!=null&&t.value?await h(t==null?void 0:t.value.id,d.value):await c(d.value);v&&(n.value=!1,i("refresh"))})}return(b,f)=>(J(),et(ot,null,[te("span",{onClick:F},[tt(b.$slots,"default")]),S(g(at),{show:n.value,"onUpdate:show":f[8]||(f[8]=v=>n.value=v),title:"角色",preset:"card","auto-focus":!1,"w-200":""},{default:k(()=>[S(g(rt),{ref_key:"formRef",ref:s,model:d.value,rules:p},{default:k(()=>[S(g(V),{path:"title",label:"角色名"},{default:k(()=>[S(g(D),{value:d.value.title,"onUpdate:value":f[0]||(f[0]=v=>d.value.title=v),placeholder:"输入角色名",onKeydown:f[1]||(f[1]=lt(it(()=>{},["prevent"]),["enter"]))},null,8,["value"])]),_:1}),S(g(V),{path:"name",label:"标识"},{default:k(()=>[S(g(D),{value:d.value.name,"onUpdate:value":f[2]||(f[2]=v=>d.value.name=v),disabled:g(z),placeholder:"请输入name"},null,8,["value","disabled"])]),_:1}),S(g(V),{path:"description",label:"描述"},{default:k(()=>[S(g(D),{value:d.value.description,"onUpdate:value":f[3]||(f[3]=v=>d.value.description=v),type:"textarea",placeholder:"请输入描述"},null,8,["value"])]),_:1}),S(g(V),{path:"parent_id",label:"父节点"},{default:k(()=>[S(st,{value:d.value.parent_id,"onUpdate:value":f[4]||(f[4]=v=>d.value.parent_id=v),clearable:"",placeholder:"请输入父节点"},null,8,["value"])]),_:1}),S(g(V),{path:"sort",label:"排序"},{default:k(()=>[S(g(xt),{value:d.value.sort,"onUpdate:value":f[5]||(f[5]=v=>d.value.sort=v),type:"textarea",placeholder:"请输入排序"},null,8,["value"])]),_:1}),S(g(V),{path:"api_ids",label:"权限"},{default:k(()=>[S($t,{value:d.value.api_ids,"onUpdate:value":f[6]||(f[6]=v=>d.value.api_ids=v)},null,8,["value"])]),_:1}),te("div",Ot,[S(g(j),{type:"primary",loading:g(r)||g(u),onClick:f[7]||(f[7]=v=>R())},{default:k(()=>[de(" 确定 ")]),_:1},8,["loading"])])]),_:1},8,["model"])]),_:1},8,["show"])],64))}}),Et=L({__name:"RolePageTree",setup(e){const{dataSource:i,loading:o,refresh:t,tableFilter:n,total:s,pagination:c}=vt(q.getRoleTreeList);async function r(u){const{result:d}=await q.delRole(u);d&&t()}const h=[{title:"序号",key:"id",width:"205",resizable:!0},{title:"角色名",key:"title",resizable:!0},{title:"标识",key:"name"},{title:"排序",key:"sort"},{title:"更新时间",key:"updated_at",width:"185"},{title:"操作",key:"action",width:"170",fixed:"right",render(u){return[l(ie,{record:u,onRefresh:t},{default:()=>l(St)}),l(Ct,{confirmText:"是否删除该角色",delFunction:()=>r(u.id)})]}}];return(u,d)=>(J(),se(pt,{"table-filter":g(n),"onUpdate:tableFilter":d[0]||(d[0]=p=>nt(n)?n.value=p:null),data:g(i),loading:g(o),columns:h,total:g(s),pagination:g(c),"search-key":"name",tree:!0,"row-key":p=>`${p.id}-${p.name}`,"search-place-holder":"请输入角色名",onRefresh:g(t)},{header:k(()=>[S(ie,{onRefresh:g(t)},{default:k(()=>[S(g(j),{type:"primary"},{default:k(()=>[de(" 新增角色 ")]),_:1})]),_:1},8,["onRefresh"])]),_:1},8,["table-filter","data","loading","total","pagination","row-key","onRefresh"]))}});export{Et as default};
