...
type PutLogReq struct {
	...
	Addr          *string        `protobuf:"bytes,13,opt,name=addr,proto3,oneof" query:"addr" form:"addr,omitempty" json:"addr,omitempty"`
...
var file_task_log_proto_rawDesc = []byte{
	...
	0x6d, 0x65, 0x32, 0x54, 0x0a, 0x0a, 0x4c, 0x6f, 0x67, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	0x12, 0x46, 0x0a, 0x06, 0x47, 0x65, 0x74, 0x4c, 0x6f, 0x67, 0x12, 0x12, 0x2e, 0x74, 0x61, 0x73,
	...
	0x70, 0x22, 0x15, 0xca, 0xc1, 0x18, 0x11, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x76, 0x31, 0x2f, 0x6a,
	0x6f, 0x62, 0x6f, 0x72, 0x2f, 0x6c, 0x6f, 0x67, 0x42, 0x1a, 0x5a, 0x18, 0x6a, 0x6f, 0x62, 0x6f,
...
var file_task_log_proto_depIdxs = []int32{
	...
	1, // 5: task_log.LogService.GetLog:output_type -> task_log.LogResp
